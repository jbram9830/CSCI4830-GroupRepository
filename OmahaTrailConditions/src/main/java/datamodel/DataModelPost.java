...
public class DataModelPost {
   ...
   public DataModelPost(String palias, String tname, Integer tscore, String pbody, Integer prcount, String timestamp) {
	 this.poster_alias = palias;
	 this.trail_name = palias;
   ...
   public DataModelPost(Integer id, String poster_alias, String trail_name, Integer trail_score, String post_body, Integer prcount, String timestamp) {
      this.post_id = id;
...
@Override
   public String toString() {
      return "Post: " + this.post_id + this.poster_alias + this.trail_name + this.trail_score + this.post_body + this.post_report_count + this.post_timestamp;
   }
}
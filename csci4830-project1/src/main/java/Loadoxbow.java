...
@WebServlet(name="/Loadoxbow", urlPatterns = "/oxbow.html")
public class Loadoxbow extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   System.out.println("the GET request has been made to /Loadoxbow");
      ...
      out.println("<head>");
	    ...
	    //SCORE TEXT
	      ...
	      for (DataModelPost post : listDataModelPosts) {
	    	  if (post.getTrail_name() == null && (post.getPost_body().contains("Oxbow") || post.getPost_body().contains("oxbow"))){
			    	  //EVENT TYPE POST
	    	  ...
	    	  else if(post.getTrail_name().contains("Oxbow")) {
		    	  //EVENT TYPE POST
		    	  if (post.getPost_type() == "e") {
		    	  		out.println("postList.push(new PostObject("+post.getPost_id()+", '"
		    	  +post.getPoster_alias()+"', '"+post.getTrail_name()+"', '"+post.getTrail_score()+"', '"

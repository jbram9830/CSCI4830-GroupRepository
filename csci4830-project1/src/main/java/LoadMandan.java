...
@WebServlet(name="/LoadMandan", urlPatterns = "/mandan.html")
public class LoadMandan extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   System.out.println("the GET request has been made to /LoadMandan");
      ...
      out.println("<head>");
	    ...
	    //SCORE TEXT
	      ...
	      for (DataModelPost post : listDataModelPosts) {
	    	  if (post.getTrail_name() == null && (post.getPost_body().contains("Mandan") || post.getPost_body().contains("mandan"))){
			    	  //EVENT TYPE POST
	    	  ...
	    	  else if(post.getTrail_name().contains("Mandan")) {
		    	  //EVENT TYPE POST
		    	  if (post.getPost_type() == "e") {
		    	  		out.println("postList.push(new PostObject("+post.getPost_id()+", '"
		    	  +post.getPoster_alias()+"', '"+post.getTrail_name()+"', '"+post.getTrail_score()+"', '"

...
public class UtilProp {
   ...
   static String _PROP_FILENAME_WIN_LOCAL = "C:\\Users\\Tyler\\CSCI4830-project1\\csci4830-project1\\src\\main\\webapp\\config.properties";
   												
   static String _PROP_FILENAME_OSX_LOCAL = "/YOUR_PATH/webproject/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat9/webapps/csci4830-project1/config.properties";
   ...
   public static void loadProperty() throws Exception {
      ...
      if (_W) {
         if (new File(_PROP_FILENAME_WIN_LOCAL).exists()) {
            System.out.println("[DBG] Loaded1: " + new File(_PROP_FILENAME_WIN_LOCAL).getAbsolutePath());
